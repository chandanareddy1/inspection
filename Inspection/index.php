...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-clock" ></i>  Site Inspection</h3>
            ...
            <?php if ( 'admin' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addManager' == $id ) {
                    ...
                    <a href="index.php?id=addManager"><i id="left" class="fas fa-user-plus"></i></i>Add Client</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allManager' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allManager"><i id="left" class="fas fa-user"></i>All Client</a>
            </li>
    ...
    echo " active";
                ...
                <a href="index.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>All Supervisor</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                <!-- For Admin, Client, Supervisor-->
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addSalesman' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="index.php?id=addSalesman"><i id="left" class="fas fa-user-plus"></i>Add Inspector</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allSalesman' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allSalesman"><i id="left" class="fas fa-user"></i>All Inspector</a>
            </li>
        </ul>
        <footer class="text-center"><span>Inspection</span><br>©2020 All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
                ...
                <?php if ( 'addManager' == $id ) {?>
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">Add New Client</div>
            ...
            <div class="salesman">
                ...
                <?php if ( 'addSalesman' == $id ) {?>
                    <div class="addSalesman">
                        <div class="main__form">
                            <div class="main__form--title text-center">Add New Inspector</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
